...
public void printDeck(String title) {
	System.out.println("");
...
private void printDeckBack(String title) {
 ...
 public void moveCard(Card c, int p) {
	...
	//#############################
  Card saveCard = c;
  Card prevCard = saveCard.prev;
  Card nextCard = saveCard.next;
  
  prevCard.next = nextCard;
  nextCard.prev = prevCard;
  Card newNextCard = nextCard;
 ...
 public void tripleCut(Card firstCard, Card secondCard) {
	 ...
	 //this.printDeck("before triplecut");
	
	 if (firstCard != this.head && secondCard != this.head.prev) { //case where there is card in both sections
	  Card fsFirst = this.head;
	  Card fsLast = firstCard.prev;
	  Card ssFirst = secondCard.next;
	  Card ssLast = this.head.prev;
	  this.head = ssFirst; //moves second section in front of first card
	  this.head.prev = fsLast;
	  this.head.next =ssFirst.next;
	  ssLast.next = firstCard;
	  firstCard.prev = ssLast;
	  
	  secondCard.next = fsFirst; //moves the first section to after the second card
	  fsFirst.prev = secondCard;
	  fsLast.next = this.head;
	...
	if(firstCard != this.head && secondCard == this.head.prev) {
		...
		secondCard.next = fsFirst;
		fsFirst.prev = secondCard;
		
		this.head = firstCard;
		this.head.next =firstCard.next;
		this.head.prev = fsLast;
		fsLast.next = this.head;
 ...
 public void countCut() {
  ...
  if (value != 0) {
	  ...
	  Card initialBeforeLast = initialLast.prev;
