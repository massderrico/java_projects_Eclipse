...
import finalproject.ChessSudoku;
...
public class testClass {
	...
	public static void main(String[] args) {
		...
		System.out.println(t1.checkStandard(9, 0, 0));
	...
	private boolean checkStandard(int value,int row, int column){ 
		...
		for (int i = 0; i < N; i++) { //loops through each column of a specified row
...
//            {
//                if(grid[k][j]== value && k != row && j!= column)
//                    return false;
//            }
//        }	
